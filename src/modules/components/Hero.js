      ...
      <div id="hero" className="hero pt-4 lg:pt-8 pb-8 mx-4 md:mx-0">
        <div className="container px-4 pt-14 lg:pt-12 xl:pt-3 sm:px-6 lg:px-14 xl:px-18 mx-auto">
          <div className="hero-wrapper grid grid-cols-1 md:grid-cols-8 lg:grid-cols-12  items-center">
            ...
            <div className="hero-text col-span-4 pr-3 lg:pr-6 ml-0 md:-ml-10">
              ...
              <div className="flex space-x-5 mt-10 justify-start">
                <motion.button initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInHidden('', 1, 0.4)} className="group inline-flex items-center space-x-2">
                  <p className="text-base md:text-sm font-semibold mr-1 px-2">View all collection</p>
            ...
            <div className="hero-shop col-span-4 md:col-span-12 lg:col-span-4 grid grid-cols-3 lg:grid-cols-2 pt-5 md:pt-10 mt-5 lg:mt-0">
              ...
              <div className="flex flex-col items-start justify-start lg:justify-between p-2 px-4 mt-6 md:mt-4 col-span-12 lg:col-span-1">
                <div className="hero-text">
                  ...
                  <ul className="mt-4 lg:text-xs text-base text-gray-400">
                ...
                <motion.button initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInHidden('down', 1, 0.7)} className="bg-black rounded-md text-white px-4 py-2 text-base md:text-sm lg:mt-0 mt-10">
                  Buy Now
                </motion.button>
              </div>
            </div>
